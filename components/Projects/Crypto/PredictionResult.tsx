...
export function PredictionResult({ prediction }: PredictionResultProps) {
  return (
    <div className="flex w-full h-fit flex-col justify-center gap-5 rounded mt-16 md:mt-0 px-5 py-4 border dark:border border-gray-300 dark:border-gray-800 dark:bg-zinc-800" >
      {/* TODO: add animation to load content */}
      <p className="text-center text-2xl"><b>{prediction?.coin.startsWith("E") ? "Ethereum" : "Bitcoin"} Prediction</b></p>
      <PredictionTable>
        <PredictionRow
          title="Prediction:"
