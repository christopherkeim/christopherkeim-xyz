...
export default function CryptoPage() {
  return (
    <>
      <CryptoHero />
      <ResearchPaper>
        <PaperHeader headerLevel={2}>Crypto Real Time Inference</PaperHeader>
        <PaperImage src="/images/project_overview.png" />
        <PaperHeader headerLevel={3}>Overview</PaperHeader>
        <PaperParagraph>
          The aim of this application is to leverage historical cryptocurrency
        ...
        <PaperParagraph>
          ...
          chosen to think of a given cryptocurrency as a complex system (read:
          chaotic system), emergent as a phenomenon of large N interactions
          between groups of humans. Inherently, this is a social system.
        </PaperParagraph>
        <PaperParagraph>
          ...
          (consisting of multiple candles) is a function that maps empirically
          measured states to time points. At a fundamental level, the same
          concepts can be applied to any physical system composed of a large
          number of interacting variables - which means this is a very
          challenging problem!
        </PaperParagraph>
        <PaperImage src="/images/BTC-USD_candle_plot.png" />
        <PaperParagraph>
          The visualization above is a snapshot of raw candle data used in this
        ...
        <PaperParagraph>
          ...
          has publically available data.
        </PaperParagraph>
        <PaperHeader headerLevel={3}>Feature Engineering</PaperHeader>
        <PaperImage src="/images/feature_engineering.png" />
        <PaperParagraph>
          Features are the variables (or information) that we give to machine
          learning models in order for them to make predictions.
        </PaperParagraph>
        <PaperParagraph>
          Feature engineering is the process of extracting meaningful
          information from raw data that describes or encodes the process we are
          measuring, with the aim of improving our supervised machine learning
          algorithm&apos;s ability to make accurate predictions. Feature
          engineering plays a very key role in this project.
        </PaperParagraph>
        <PaperParagraph>
          The raw OHLC (&quot;open&quot;, &quot;high&quot;, &quot;low&quot;,
          &quot;close&quot;) candle data is not fit for supervised machine
          learning modeling as is when we pull it down from Coinbase - it must
          be processed into a set of predictive features (an &quot;X&quot;
        ...
        <PaperParagraph>
          ...
          that we can use to train supervised machine learning models.
        </PaperParagraph>
        <PaperHeader headerLevel={3}>Modeling</PaperHeader>
        <PaperImage src="/images/training.png" />
        <PaperParagraph>
          You can think of our feature engineering process as transforming the
          raw dataset of OHLC candles, which constitutes a 6-dimensional
          geometric space, into a 68-dimensional geometric space. Each candle
          which was once a 6-dimensional point is now a 68-dimensional point in
          this new space.
        </PaperParagraph>
        <PaperParagraph>
          In this sense, during model development we are training models to map
          68-dimensional points in our feature space to 1-dimensional points in
          our target space.
        </PaperParagraph>
        <PaperParagraph>
        ...
        <PaperParagraph>
          The two machine learning algorithms I chose to explore here are the
          Lasso Regressor and Light Gradient Boosted Machine Regressor
        ...
        <PaperParagraph>
          ...
          incorporates a regularization term called L1 regularization, which is
          also known as the &quot;Lasso&quot; (Least Absolute Shrinkage and
          Selection Operator). The Lasso Regressor is designed to prevent
          overfitting and to perform feature selection by encouraging some of
        ...
        <PaperParagraph>
          ...
          learning algorithm designed to be fast and memory-efficient. LightGBM
          is a gradient boosting framework, which means it builds a predictive
          model by combining the predictions of multiple weaker models,
          typically decision trees - these are also known as ensemble methods.
        </PaperParagraph>
        <PaperParagraph>
        ...
        <PaperParagraph>
          ...
          to be suited for time series data. Ultimately I decided to move onto
        ...
        <PaperParagraph>
          ...
          well, but I found that it was both slow and cumbersome and ill-suited
          for our features.
        </PaperParagraph>
        <PaperParagraph>
          CNNs are typically used for image analysis tasks, but it turned out to
          be a great model to adapt for analyzing time series data.
        </PaperParagraph>
        <PaperParagraph>
          CNNs use convolutional layers as their core building blocks. These
          layers consist of small filters (also known as kernels or receptive
          fields) that slide over the input feature vector.
        </PaperParagraph>
        <PaperParagraph>
          The filters are responsible for capturing various local patterns in
          the data, such as edges, textures, and other low-level features in a
          typical image example. Here, local patterns in our cryptocurrency data
          would be relationships between previous price points and other
          information I calculated during feature engineering.
        </PaperParagraph>
        <PaperParagraph>
          During the convolution operation, each filter scans the input vector
          and computes the element-wise dot product between the filter and the
          &quot;local region&quot; of the vector (meaning neighboring
          variables). This process generates a feature map for each filter.
        </PaperParagraph>
        <PaperParagraph>
          A technique called pooling reduces the sizes of the computed feature
          maps, and once the feature maps have been extracted and pruned they
          are fed into a series of fully connected layers which perform
          traditional neural network operations.
        </PaperParagraph>
        <PaperParagraph>
          A key hyperparameter I selected during experimentation was to use a
          kernel size of 4, meaning that the CNN scans the input vector 4
          variables at a time. Using a 1-dimensional convolutional layer, this
          effectively allowed the model to discover patterns in price and volume
          changes over the past 24 hours, which I layed out sequentially within
          each feature vector.
        </PaperParagraph>
        <PaperHeader headerLevel={5}>
        ...
        <PaperParagraph>
          A battery of experiments were run testing the Lasso Regressor, Light
          Gradient Boosted Machine Regressor (LGBMRegressor), Long Short-Term
          Memory (LSTM) Neural Network, and Convolution Neural Network (CNN)
          models respectively.
        </PaperParagraph>
        <PaperParagraph>
          The Lasso Regressor performed extremely well for it&apos;s simplicity
          - it&apos;s a lightweight, efficient, and beautiful algorithm, very
          fast to train and easy to deploy. It garnered a mean absolute error of
          88.143 on Bitcoin price predictions (fig.1) and 5.750 on Ethereum
          price predictions (fig.3).
        </PaperParagraph>
        <PaperParagraph>
          I found that a Convolutional Neural Network (CNN) performed far better
          on both Bitcoin and Ethereum predictions compared to a Long-Short Term
          Memory (LSTM) Neural Network, and it&apos;s relative parameter
          simplicity combined with its accuracy made it a clear choice for
          deployment. The CNN model garnered a mean absolute error of 64.711 on
          Bitcoin price predictions (fig.2) and 4.474 on Ethereum price
          predictions (fig.4).
        </PaperParagraph>
        ...
        <PaperParagraph>
          ...
          model. The Prediction Service is containerized with Docker.
        </PaperParagraph>
        <PaperParagraph>
        ...
        <PaperParagraph>
          Our Prediction Service is deployed onto a Raspberry Pi 5, which runs
          using an arm64 microchip.
        </PaperParagraph>
        <PaperParagraph>
          ...
          deployment targets down the road as requirements change, and a lot of
          ease in terms of deployment choices for any of the big cloud
          providers.
        </PaperParagraph>
        <PaperParagraph>
          I used a matrix build triggered inside of a GitHub Action to
          concurrently build two separate Docker images: the first is executable
          on an amd64 microchip, and the second can be executed on an arm64
          microchip.
        </PaperParagraph>
        <PaperParagraph>
        ...
        <PaperParagraph>
          ...
          natively uses an amd64 chip) we build the Prediction Service into a
        ...
        <PaperParagraph>
          ...
          services on the Raspberry Pi, which starts them on boot and restarts
          them on any failures.
        </PaperParagraph>
      </ResearchPaper>
    </>
  );
